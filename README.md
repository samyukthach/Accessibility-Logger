...
Ensure your code is well-documented and follows the project style.
If adding new accessibility checks, map issues to relevant WCAG success criteria.
Ensure the features should be accessible.
Respect the Code of Conduct in all communications and contributions.
